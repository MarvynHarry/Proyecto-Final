...
namespace proyecto_final.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Nombre,clave,tipo")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Nombre,clave,tipo")] Usuarios usuarios)
        {
            if (ModelState.IsValid)
            {
